...
const [selectedDate, setSelectedDate] = useState(new Date());
 ...
 const fetchdata = async () => {
    try {
      const response = await axios.get(`https://iamtanish.me/hms/single/${id}`, {
        headers: {
...
const handlesave=async()=>{
  ...
  try {
    ...
    const response = await axios.patch(`https://iamtanish.me/hms/update-date`, {_id:id,date:selectedDate}, {
      headers: {
        'Content-Type': 'application/json',
        authorization: localStorage.getItem('jwt'),
      },
  ...
  const handleSubmit = async(e) => {
    ...
    try {
        const response = await axios.patch(`https://iamtanish.me/hms/update-medicine`, {_id:id,medicine,about}, {
          headers: {
            'Content-Type': 'application/json',
            authorization: localStorage.getItem('jwt'),
          },
